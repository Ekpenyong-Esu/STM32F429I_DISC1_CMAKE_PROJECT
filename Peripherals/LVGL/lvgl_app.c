...
static void create_home_screen(void)
{
     ...
     *-----------------------------------------------------------------*/
    lv_obj_t *log_card = make_card(scr_home, 4, 218, 312, 210);
    ...
    lv_obj_set_size(log_list, 298, 178);
...
static void create_config_screen(void)
{
    ...
    lv_obj_set_style_bg_opa(scr_config, LV_OPA_COVER, 0);
...
static void create_info_screen(void)
{
    ...
    lv_obj_set_style_bg_opa(scr_info, LV_OPA_COVER, 0);
...
static void create_pins_screen(void)
{
    ...
    lv_obj_set_style_bg_opa(scr_pins, LV_OPA_COVER, 0);
...
static void create_pin_detail_screen(void)
{
    ...
    lv_obj_set_style_bg_opa(scr_pin_detail, LV_OPA_COVER, 0);
